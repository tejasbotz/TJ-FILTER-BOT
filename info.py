...
AUTH_CHANNEL = environ.get('AUTH_CHANNEL', '-1002024156024')
AUTH_GROUPS = environ.get('AUTH_GROUPS', '-1001953643341')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '89e6e36b347f3db3f187dda37290c5927e99c18a')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/top_filmy_degree_21_2')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002023697642'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/the_owner_support/5')
...
URL = "https://tj-filter-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tj-filter-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tj-filter-bot.onrender.com/".format(FQDN)
else:
    URL = "https://tj-filter-bot.onrender.com/".format(FQDN)
